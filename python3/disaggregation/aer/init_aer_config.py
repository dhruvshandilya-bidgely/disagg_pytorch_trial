...
def init_aer_config(pipeline_input_object):
    ...
    config = {
        ...
        'module_seq': pipeline_input_object.get('global_config').get('disagg_aer_seq'),
        ...
        'enable_hybrid_v2': pipeline_input_object.get('global_config').get('enable_hybrid_v2'),
        'enable_ev_by_default': pipeline_input_object.get('global_config').get('enable_ev_by_default'),
        'build_info': pipeline_input_object.get('global_config').get('build_info'),
    }
