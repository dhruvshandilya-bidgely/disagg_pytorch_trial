...
def get_meta_data(weather_data, wh_config):
    ...
    weather_data['meta_data']['property_type'] = wh_config['home_meta_data'].get('dwelling')
    weather_data['meta_data']['property_area'] = wh_config['home_meta_data'].get('livingArea', 'N/A')
    weather_data['meta_data']['city'] = wh_config['home_meta_data'].get('city', 'N/A')
    weather_data['meta_data']['country'] = wh_config['home_meta_data'].get('country', 'N/A')
