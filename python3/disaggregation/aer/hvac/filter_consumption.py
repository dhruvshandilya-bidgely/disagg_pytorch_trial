...
def filter_by_mode(hvac_input_data, all_indices, detection_debug, logger_base, estimation_debug=None,
                   hvac_params=None):
    ...
    Parameters:
        ...
        all_indices         (dict)              : Dict carrying all month/epoch/day indices
    ...
    filter_info = {
        ...
        'epoch_filtered_data_minhrs_day': pd.DataFrame(),
        'epoch_filtered_data_minhrs_month': pd.DataFrame()
    }
    ...
    for mode in unique_modes:
        ...
        if estimation_debug['exist'] and not np.isnan(detection_debug['mu']) and (mode >= 0):
            ...
            epoch_hvac_filtered_minhrs_day = copy.deepcopy(epoch_hvac_filtered_data)
            ...
            epoch_hvac_filtered_minhrs_month = copy.deepcopy(epoch_hvac_filtered_data)
            ...
            filter_info['epoch_filtered_data_minhrs_day'][mode] = epoch_hvac_filtered_minhrs_day
            filter_info['epoch_filtered_data_minhrs_month'][mode] = epoch_hvac_filtered_minhrs_month
