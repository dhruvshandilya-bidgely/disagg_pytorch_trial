...
Date - 26/11/2019
get lighting params extracts parameters needed to generate the lighting estimate from the data
"""
...
def get_lighting_params(data_season_rem, smoothing_noise_bound, perc_season, num_periods, pd_mult, config, debug,
                        logger_pass):
    ...
    fractional_band_cap = config.get('LIGHTING_BAND_CAP') / 24
